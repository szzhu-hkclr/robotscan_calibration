    ...
    if Setup603:
        ...
        if SetupMechEye:
            ...
            if SetupPatternSize6:
                ...
                # 16w 01-17
                end_T_cam_ori = np.array([[-4.69196201e-04,  9.99961201e-01, -8.79633495e-03, -3.60227528e-02],
    ...
    if Setup603:
        ...
        if SetupPatternSize6:
            ...
            dh_params_new = np.array([[0.550, 0.170, 0.5*pi, 0.0],
                            [0.0, 0.880, 0.0, 0.5*pi],
                            [0.0, 0.190, 0.5*pi, 0.0],
                            [8.1010616e-01, -3.8129519e-04, -1.5701258e+00,  2.0415702e-05],
                            [1.26107159e-04, 1.17182695e-04, 1.57024145e+00, 5.60347806e-04],
                            [1.1500830e-01,  4.6946361e-06, -3.3456785e-05,  9.3496355e-06]])
    ...
    if Setup603:
        ...
        if SetupMechEye:
            ...
            if SetupPatternSize6:
                ...
                # 16w 01-17
                end_T_cam = np.array([[-0.00105313,  0.99996221, -0.00862912, -0.03626875],
